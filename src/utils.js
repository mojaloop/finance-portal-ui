...
const setDate = (dt, { year, month, day, hour, minute, second, milli } = {}) => {
...
const truncateDate = (dt, { year = false, month = false, day = false, hour = true, minute = true, second = true, milli = true } = {}) => {
    return setDate(new Date(dt), {
